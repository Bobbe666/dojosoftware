...
const APP_REGISTRY = [
  ...
  },
  {
    id: 'finanzen',
    name: 'Finanzen',
    short: 'Beleg-Scanner & Buchhaltungs-Upload',
    url: 'https://finanzen.tda-intl.org',
    icon: '🧾',
    category: 'pwa',
    tech: { frontend: 'React/Vite PWA', backend: '— (nutzt Dojo API)' },
    pm2: null,
    port: null,
    localPath: '/Users/schreinersascha/finanzen-app',
    serverPath: '/var/www/finanzen-app',
    deploy: './deploy.sh',
    notes: 'Beleg fotografieren → KI-OCR (Claude Vision) → Positionen Betrieb/Privat → direkt in EÜR buchen. Zugriffsrechte pro Nutzer verwaltbar.',
    hasAccessManagement: true,
  },
  {
    id: 'trainer',
    name: 'Trainer App',
    short: 'Trainingsplanung & Anwesenheit',
    url: 'https://trainer.tda-intl.org',
    icon: '🥋',
    category: 'pwa',
    tech: { frontend: 'React/Vite PWA', backend: '— (nutzt Dojo API)' },
    pm2: null,
    port: null,
    localPath: '/Users/schreinersascha/trainer-app',
    serverPath: '/var/www/trainer-app',
    deploy: './deploy.sh',
    notes: 'PWA für Trainer — Stundenplan, Anwesenheit, Mitgliederliste. Zugriffsrechte pro Nutzer verwaltbar.',
    hasAccessManagement: true,
  },
  {
    id: 'support',
    name: 'Support Portal',
    short: 'Helpdesk & Ticket-System',
    url: 'https://support.tda-intl.org',
    icon: '🎧',
    category: 'pwa',
    tech: { frontend: 'React/Vite PWA', backend: '— (nutzt Dojo API)' },
    pm2: null,
    port: null,
    localPath: '/Users/schreinersascha/support-app',
    serverPath: '/var/www/support-app',
    deploy: './deploy.sh',
    notes: 'Support-Tickets, Helpdesk für Dojo-Admins. Zugriffsrechte pro Nutzer verwaltbar.',
    hasAccessManagement: true,
  },
];
  ...
  try {
    const [rows] = await db.promise().query(`
      SELECT au.id, au.vorname, au.nachname, au.email, au.username, au.rolle, au.dojo_id,
             ...
             COALESCE(au.finanzen_app_access, 0)  AS finanzen_app_access,
             d.dojoname
      FROM admin_users au
