...
const KATEGORIE = {
  ...
  SYSTEM: 'SYSTEM',
  AUTH: 'AUTH',
  TRAINING: 'TRAINING',  // Trainer-App / Kurse / Vertretungen
...
const AKTION = {
  ...
  // Import
  IMPORT_GESTARTET: 'IMPORT_GESTARTET',
  IMPORT_ABGESCHLOSSEN: 'IMPORT_ABGESCHLOSSEN',
  IMPORT_FEHLGESCHLAGEN: 'IMPORT_FEHLGESCHLAGEN',
  ...
  // Training / Vertretung (Coach-App)
  VERTRETUNG_ANGEFRAGT: 'VERTRETUNG_ANGEFRAGT',
  VERTRETUNG_ZUGESAGT: 'VERTRETUNG_ZUGESAGT',
  VERTRETUNG_ZUSAGE_ZURUECKGEZOGEN: 'VERTRETUNG_ZUSAGE_ZURUECKGEZOGEN',
  VERTRETUNG_STORNIERT: 'VERTRETUNG_STORNIERT',
