-- Insert Demo Members into Demo-Dojo (id=4) ONLY
-- ⚠️ dojo_id ist fest auf 4 gesetzt — NIEMALS in Produktions-Dojos schreiben!
...
BEGIN
    ...
    WHILE i <= 400 DO
        ...
        INSERT INTO mitglieder (
            ...
            v_eintrittsdatum, IF(RAND() < 0.9, 1, 0), 4,
            ELT(1 + FLOOR(RAND() * 2), 'Lastschrift', 'Bar'),
            IF(RAND() < 0.7, 1, 0),
            IF(RAND() < 0.8, 1, 0),
            1, 1,
            FLOOR(RAND() * 500)
