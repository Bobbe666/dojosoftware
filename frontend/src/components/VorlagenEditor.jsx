...
const KATEGORIEN = [
  { gruppe: 'Mitgliedschaft', items: [
    ...
    { value: 'vertrag_verlaengerung', label: 'Vertragsverlängerung Angebot' },
    { value: 'vertrag_bestaetigung', label: 'Vertragsverlängerung Bestätigung' },
...
const PLATZHALTER = [
  ...
  { gruppe: 'Kontext', items: [
    ...
    { key: '{{monatsbeitrag}}', label: 'Monatsbeitrag' },
    { key: '{{zahlungsweise}}', label: 'Zahlungsweise' },
    { key: '{{zahlungsfrist}}', label: 'Zahlungsfrist' },
    { key: '{{antwortfrist}}', label: 'Antwortfrist' },
    { key: '{{mahngebuehr}}', label: 'Mahngebühr' },
    { key: '{{kurs_name}}', label: 'Kursname' },
    { key: '{{kurs_datum}}', label: 'Kursdatum' },
    { key: '{{kurs_uhrzeit}}', label: 'Kurs-Uhrzeit' },
    { key: '{{kurs_ort}}', label: 'Kurs-Ort' },
    { key: '{{pruefung_ergebnis}}', label: 'Prüfungsergebnis' },
    { key: '{{guertelstufe}}', label: 'Gürtelstufe' },
    { key: '{{lizenz_typ}}', label: 'Lizenz-Typ' },
    { key: '{{lizenz_nr}}', label: 'Lizenz-Nr.' },
