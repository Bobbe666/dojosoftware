          ...
          <div style={{display: openSection === 'digital' ? 'block' : 'none'}}>
              ...
              <div className="form-section" id="fs-design" style={{display: (!openSub || openSub === 'fs-logos') ? 'block' : 'none'}}>
                ...
                <div className="dtab-style-grid">
                  {[
                    { id: 'glass', label: 'Glass', desc: 'Gradient & Glassmorphism (Standard)', normal: { background: 'linear-gradient(135deg, rgba(255,215,0,0.12), transparent)', borderRadius: '16px', color: 'var(--ds-text)', border: 'none' }, active: (c) => ({ background: `linear-gradient(135deg, ${c}33, ${c}18, rgba(255,107,53,0.1))`, borderRadius: '16px', color: c, border: 'none' }) },
                    { id: 'underline', label: 'Underline', desc: 'Minimal mit Unterstrich', normal: { background: 'transparent', borderRadius: '0', color: 'var(--ds-text-muted)', borderBottom: '2px solid transparent', paddingBottom: '5px' }, active: (c) => ({ background: 'transparent', borderRadius: '0', color: c, borderBottom: `2px solid ${c}`, paddingBottom: '5px' }) },
                    { id: 'pill-solid', label: 'Pill', desc: 'Solide Pill mit Akzentfarbe', trackStyle: { background: 'rgba(255,255,255,0.04)', borderRadius: '100px', padding: '3px', border: '1px solid rgba(255,255,255,0.07)' }, normal: { background: 'transparent', borderRadius: '100px', color: 'var(--ds-text-muted)', border: 'none' }, active: (c) => ({ background: c, borderRadius: '100px', color: '#1a1a0a', border: 'none' }) },
                    { id: 'frosted', label: 'Frosted', desc: 'Tabs auf Glasfläche', trackStyle: { background: 'rgba(255,255,255,0.03)', borderRadius: '10px', padding: '3px', border: '1px solid rgba(255,255,255,0.06)' }, normal: { background: 'transparent', borderRadius: '7px', color: 'var(--ds-text-muted)', border: '1px solid transparent' }, active: (c) => ({ background: `${c}1a`, borderRadius: '7px', color: c, border: `1px solid ${c}40` }) },
                    { id: 'bordered', label: 'Bordered', desc: 'Klare Rahmen-Ansicht', normal: { background: 'transparent', borderRadius: '7px', color: 'var(--ds-text-muted)', border: '1px solid rgba(255,255,255,0.1)' }, active: (c) => ({ background: `${c}14`, borderRadius: '7px', color: c, border: `1px solid ${c}` }) },
                  ].map((style) => (
