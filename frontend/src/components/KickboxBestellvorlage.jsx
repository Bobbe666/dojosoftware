      ...
      <div className="gv-body">
        ...
        <div className="gv-section">
          ...
          <div className="gv-field" style={{ marginTop: '0.65rem' }}>
            ...
            <input className="gv-input" value={spez.verp_label || ''} onChange={fSpez('verp_label')} placeholder="z. B. KICKBOXANZUG · Gr. XXX · Art. Nr. XXXX · Dein Dojo" />
          </div>
...
export function buildKickboxPdf(form, origin, eingebetteteDateien = [], bestellungId = null, lang = 'de') {
  ...
  const T = {
    docTitle:       `Kickboxanzug Bestellvorlage – ${org}`,
    h1:             'Kickboxanzug',
    sub:            `Bestellvorlage · ${org}  ·  Order Form`,
    nr:             'Nr. / No.',
    datum:          'Datum / Date:',
    pageHeader:     `Kickboxanzug Bestellvorlage / Order Form – ${org}`,
