        ...
        {raeume.map((raum) => (
          ...
          >
            <div className="room-header">
              <div className="room-color" style={{ '--room-color': raum.farbe }}></div>
              ...
              <div className="room-actions u-flex-gap-sm">
                {editingId === raum.raum_id ? (
                  <>
                    <button
            ...
            {editingId === raum.raum_id ? (
              <div className="room-edit-form">
                <div className="form-group rv2-form-group-mb">
                  <label className="rv2-edit-label">Beschreibung</label>
                  <input
                    type="text"
                    value={raum.beschreibung || ''}
                    onChange={(e) => updateRoomProperty(raum.raum_id, 'beschreibung', e.target.value)}
                    className="rv2-edit-input"
                  />
                </div>

                <div className="form-row u-grid-2col">
                  <div className="form-group u-flex-col-sm">
                    <label className="rv2-edit-label">Größe</label>
                    <input
                      type="text"
                      value={raum.groesse || ''}
                  ...
                  <div className="form-group u-flex-col-sm">
                    <label className="rv2-edit-label">Kapazität</label>
                    <input
                      type="number"
                ...
                <div className="form-row u-grid-2col">
                  <div className="form-group u-flex-col-sm">
                    <label className="rv2-edit-label">Farbe</label>
                    <input
                      type="color"
                      value={raum.farbe || '#4F46E5'}
                      onChange={(e) => updateRoomProperty(raum.raum_id, 'farbe', e.target.value)}
                      className="rv2-color-picker"
                    />
                  </div>

                  <div className="form-group rv2-form-group-end">
                    <label className="rv2-checkbox-label">
                      <input
                        type="checkbox"
                        checked={raum.aktiv}
                ...
                <div className="room-info">
                  {raum.groesse && (
                    <div className="room-info-item">
                      <Square size={14} className="u-text-accent" />
                  ...
                  {raum.kapazitaet && (
                    <div className="room-info-item">
                      <Users size={14} className="u-text-accent" />
