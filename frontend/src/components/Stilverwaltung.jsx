...
import StilStatistikenTab from './StilStatistikenTab';
import StilAllgemeinTab from './StilAllgemeinTab';
import StilPruefungseinstellungenTab from './StilPruefungseinstellungenTab';
import StilMitgliederTab from './StilMitgliederTab';
          ...
          {!currentStil ? (
            ...
            <div className="stil-detail">
              ...
              <div className="tab-content">
                {activeTab === 'allgemein' && (
                  <StilAllgemeinTab
                    currentStil={currentStil}
                    setCurrentStil={setCurrentStil}
                    loading={loading}
                    updateStil={updateStil}
                    deleteStil={deleteStil}
                  />
                )}

                {activeTab === 'pruefungseinstellungen' && (
                  <StilPruefungseinstellungenTab
                    stile={stile}
                    currentStil={currentStil}
                    setCurrentStil={setCurrentStil}
                    loading={loading}
                ...
                {activeTab === 'stilmitglieder' && (
                  <StilMitgliederTab
                    currentStil={currentStil}
                    stilMitglieder={stilMitglieder}
                    stilMitgliederLoading={stilMitgliederLoading}
                    stilMitgliederSearch={stilMitgliederSearch}
                    setStilMitgliederSearch={setStilMitgliederSearch}
                    showMemberPicker={showMemberPicker}
                    setShowMemberPicker={setShowMemberPicker}
                    memberPickerSearch={memberPickerSearch}
                    setMemberPickerSearch={setMemberPickerSearch}
                    bulkGradMode={bulkGradMode}
                    setBulkGradMode={setBulkGradMode}
                    bulkSelectedIds={bulkSelectedIds}
                    setBulkSelectedIds={setBulkSelectedIds}
                    bulkTargetGradId={bulkTargetGradId}
                    setBulkTargetGradId={setBulkTargetGradId}
                    bulkSaving={bulkSaving}
                    removeMemberFromStil={removeMemberFromStil}
                    handleBulkGraduierung={handleBulkGraduierung}
                  />
                )}
