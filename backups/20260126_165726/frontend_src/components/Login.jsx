...
import { User, Mail, Lock, Eye, EyeOff, AlertCircle, CheckCircle, Shield, Info, UserPlus, LogIn, Users } from 'lucide-react';
      ...
      <div className="login-split-layout">
        ...
        <div className="login-forms-area">
          <div className="forms-container">
            ...
            {/* Register Card - Dojo-Registrierung */}
            <div className="register-card">
              <div className="login-card-title">
                <UserPlus size={16} />
                <span>Dojo registrieren</span>
              </div>

              <div className="register-content">
                <p className="register-description">
                  Neu bei DojoSoftware? Registrieren Sie Ihr Dojo jetzt und starten Sie Ihre 14-tägige kostenlose Testphase.
                </p>
                ...
                <p className="register-note">
                  <Info size={14} />
                  <span>Eigenes Dojo anlegen mit 14 Tage Testphase</span>
                </p>
              </div>
            </div>
            ...
            <div className="member-link-card">
              <Users size={16} />
              <span>Sie sind Mitglied eines Dojos?</span>
              <Link to="/mitglieder-login" className="member-login-link">
