...
function LandingPage() {
  ...
  const fallbackPricing = [
    { plan_name: 'starter', display_name: 'Starter', price_monthly: '49.00', max_members: 100 },
    { plan_name: 'professional', display_name: 'Professional', price_monthly: '89.00', max_members: 300 },
    { plan_name: 'premium', display_name: 'Premium', price_monthly: '149.00', max_members: 999999 }
  ];
            ...
            {comparisonData.categories.map((category) => (
              <div key={category.id} className={`comparison-card ${category.is_highlight ? 'highlight-card' : ''}`}>
                <div className="card-header">
                  ...
                  <h3>{category.name}</h3>
                  {category.is_highlight && category.highlight_note && (
